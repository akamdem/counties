...
st.subheader("Tell me a county that you love, and I'll give you a list of 5 similar counties that could be a great fit for you to travel/work in, ordered by their statistical similarity scores (Euclidean Distances)")
