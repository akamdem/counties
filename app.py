...
st.subheader("Tell me a county that you love, and I'll give you a list of 5 similar counties that could be a great fit for you to travel/work in, ordered by Cosine Similarity Scores")
...
def similar_county(countyInput, stateInput):
    ...
    for item in sorted_scores:
        ...
        if j > 4:
            break
    return pd.DataFrame({'County': output_place, 'Similarity Score (1.00 is best)': outputscore, 'Pop': pop, 'Density': density, 'Median age': age, 'Percent international': english, 'Median Income': income, 'Percent with Bachelors': bachelor, 'Broadband connection rate': broadband})
